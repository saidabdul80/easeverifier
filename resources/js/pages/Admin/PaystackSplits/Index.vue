    ...
    <AdminLayout :user="$page.props.auth.user">
        <div class="d-flex align-center mb-6">
            <div>
                ...
                <p class="text-body-2 text-grey">Track PayGo settlements across system and customer Paystack accounts.</p>
            </div>
        </div>
                ...
                <v-table density="comfortable">
                    ...
                    <tbody>
                        ...
                        <tr v-if="!ledgers.data.length">
                            <td colspan="10" class="text-center text-grey py-8">No Paystack split ledger entries found.</td>
                        </tr>
                    </tbody>
                </v-table>
