...
const form = useForm({
    ...
    account_type: props.customer.customer?.account_type || 'individual',
    ...
    website: props.customer.customer?.website || '',
    use_case: props.customer.customer?.use_case || '',
    expected_monthly_volume: props.customer.customer?.expected_monthly_volume || '',
});
