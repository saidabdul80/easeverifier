import{_ as k}from"./CustomerLayout.vue_vue_type_script_setup_true_lang-BGPLDlmi.js";import{d as C,m as U,r as s,c as y,o as E,a as t,u as D,h as V,w as n,b as l,e as u,t as r,F as x,f as N}from"./app-D3HX0bah.js";import"./index-Bhb5BNBb.js";const G={class:"mb-6"},F={class:"mb-2"},q={class:"mb-3"},L={class:"text-body-2 mb-2"},H={class:"bg-grey-darken-4 text-green-lighten-1 pa-4 rounded overflow-x-auto"},j={class:"bg-grey-darken-4 text-white pa-4 rounded overflow-x-auto"},_="https://verify.ashlabtech.ng/api/v1",R="11111111111",z=`{
  "success": true,
  "status": 200,
  "data": {
    "first_name": "John",
...
}`,X=C({__name:"Documentation",props:{user:{}},setup(w){const m=U("overview"),g=[{board:"WAEC",form:"GET /results/waec/form",fetch:"POST /results/waec/fetch",fields:["txtExamNumber","ExamYear","ExamType","txtPIN","txtCardSerialNo"],sample:`{
  ...
  "reg_no": "1234567890",
  "token": "123456789012"
}`},{board:"NBAIS",form:"GET /results/nbais/form",fetch:"POST /results/nbais/fetch",fields:["parent_cat","sub_cat","year","month-select","exam_type","exam_no","pin","serial"],sample:`{
  "parent_cat": "8",
  "sub_cat": "1214",
  "year": "2022",
  ...
  "serial": "NER100000000",
  "pin": "123456789012"
}`}],A={curl:`curl -X POST ${_}/verify/nin \\
  -H "Authorization: Bearer YOUR_BEARER_TOKEN" \\
  -H "Content-Type: application/json" \\
  -d '{"nin":"${R}","consent":true}'`,javascript:`const response = await fetch('${_}/results/nabteb/fetch', {
  method: 'POST',
  headers: {
...
$response = $client->post('${_}/result-pins/purchase', [
    'headers' => [
        'Authorization' => 'Bearer YOUR_BEARER_TOKEN',
        'Content-Type' => 'application/json',
    ],
